...
#include "esphome/components/my_remote_base/my_remote_base.h"
...
class RemoteReceiverComponent : public my_remote_base::RemoteReceiverBase,
                                public Component
#ifdef USE_ESP32
    ,
                                public my_remote_base::RemoteRMTChannel
#endif
{
 public:
#ifdef USE_ESP32
  RemoteReceiverComponent(InternalGPIOPin *pin, uint8_t mem_block_num = 1)
      : RemoteReceiverBase(pin), my_remote_base::RemoteRMTChannel(mem_block_num) {}
#else
